...
class ColHomeAdapter(private val onItemClick: (ListEventsItem) -> Unit) :
    ListAdapter<ListEventsItem, ColHomeAdapter.MyViewHolder>(EventAdapter.DIFF_CALLBACK) {

    class MyViewHolder(private val binding: ItemColHomeBinding) :
